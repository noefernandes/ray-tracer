...
namespace rt3 {
    ...
    BackgroundColor * create_color_background( const ParamSet &ps )
    {
        ...
        vec3<float> c1 = rt3::retrieve<vec3<float>>(ps, "bl");
        vec3<float> c2 = rt3::retrieve<vec3<float>>(ps, "tl");
        vec3<float> c3 = rt3::retrieve<vec3<float>>(ps, "tr");
        vec3<float> c4 = rt3::retrieve<vec3<float>>(ps, "br");
        return new BackgroundColor( c1, c2, c3, c4 );
