...
namespace rt3 {
    ...
    struct RenderOptions
    {
        ...
        // the materials
        std::vector<std::shared_ptr<BlinnMaterial>> named_materials;
        // ambient light
    ...
    class API
    {
        ...
        public:
            ...
            static void object( const std::vector<std::shared_ptr<GeometricPrimitive>> objects_ );
            static void lights( const std::vector<std::shared_ptr<Light>> lights_ );
            static void make_named_materials( const std::vector<std::shared_ptr<BlinnMaterial>> named_materials_ );
            static void setAmbientLight(AmbientLight* ambient);
    };
}  // namespace rt3
